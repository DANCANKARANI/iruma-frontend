...
const EditTechnician: React.FC<EditTechnicianProps> = ({ technician, onBack }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_ENDPOINT}/api/v1/admin/technician/${formData.id}`,
        {
          method: "PUT",
          headers: {
      ...
      console.log("Updated Technician:", updatedTechnician);
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <h2 className="text-3xl font-semibold mb-4">Edit Technician</h2>
